        ...
        <Row className='mb-2'>
          ...
          <Col  sm='6'>
            {!editMode ? (
              ...
              <FormInput data-testid='contact-details-input' size='md' id="#first-name" placeholder={firstName} onChange={(e)=> {
        ...
        <Row  className='mb-2'>
          ...
          <Col  sm='6' >
            {!editMode ? (
              ...
              <FormInput data-testid='contact-details-input' size='md' id="#last-name" placeholder={lastName} onChange={(e)=> {
        ...
        <Row>
          ...
          <Col  sm='6' >
            <div>{!editMode ? (
              ...
              <FormInput data-testid='contact-details-input' disabled={!editMode} size='md' id="#phone" placeholder={phoneNumber} onChange={(e)=> {
